...
//        Vitamio.isInitialized(getApplicationContext());
        if (!LibsChecker.checkVitamioLibs(this))
            return;
        setContentView(R.layout.activity_vitamio_vidioplayer);
        //所有的View对象初始化
        init();
        setListener();
        ...
        videoview.setOnPreparedListener(new io.vov.vitamio.MediaPlayer.OnPreparedListener() {
            ...
            public void onPrepared(MediaPlayer mp) {
                ...
                //Toast.makeText(VitamioVideoPlayerActivity.this,"万能视频播放！",Toast.LENGTH_SHORT).show();
            }
        });
        ...
        videoview.setOnErrorListener(new MediaPlayer.OnErrorListener() {
            ...
            public boolean onError(MediaPlayer mp, int what, int extra) {
                Toast.makeText(VitamioVideoPlayerActivity.this,"视频播放出错！",Toast.LENGTH_LONG).show();
                finish();//如果万能播放器都不能播放就提示错误并退出
                return true;
            }
        });
        ...
        videoview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(VitamioVideoPlayerActivity.this,"点击了",Toast.LENGTH_SHORT).show();
                //videoview.pause();
            }
        });
